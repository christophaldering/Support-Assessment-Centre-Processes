  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-6 py-12">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-brand-navy mb-1" data-testid="text-welcome">
        ...
        {!assessmentLoading && noAssessment && (
          <div className="bg-white border border-slate-200 rounded-xl p-8" data-testid="text-no-assessment">
            <div className="text-center py-8">
              ...
              <h2 className="text-lg font-semibold text-brand-navy mb-2">Kein Assessment zugewiesen</h2>
              <p className="text-sm text-slate-500 max-w-md mx-auto">
                Ihnen wurde noch kein Assessment zugewiesen.
              </p>
            </div>
          </div>
        )}
        ...
        {!assessmentLoading && assessment && (
          <>
            <div className="bg-white border border-slate-200 rounded-xl p-6 mb-6" data-testid="card-assessment-info">
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  {assessment.description && (
                    <p className="text-sm text-slate-600 mt-1" data-testid="text-assessment-description">
                      {assessment.description}
                    </p>
                  )}
                </div>
                <span
                  className={`text-xs font-medium px-2.5 py-1 rounded-full ${statusColor(assessment.status)}`}
              ...
              <div className="flex flex-wrap gap-4 text-sm text-slate-500">
                {assessment.location && (
                  <div className="flex items-center gap-1.5" data-testid="text-assessment-location">
                ...
                {assessment.startDate && (
                  <div className="flex items-center gap-1.5" data-testid="text-assessment-dates">
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            ...
            {assessment.exercises.length > 0 && (
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-brand-navy mb-3" data-testid="text-exercises-heading">
                  Übungen
                </h3>
                  ...
                  {assessment.exercises.map((exercise) => (
                    ...
                    >
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <span className="text-xs font-medium bg-brand-blue/10 text-brand-blue px-2.5 py-1 rounded-full">
            ...
            {assessment.documents.length > 0 && (
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-brand-navy mb-3" data-testid="text-documents-heading">
                  Unterlagen
                </h3>
                  ...
                  {assessment.documents.map((doc) => (
                    ...
                    >
                      <div className="min-w-0 flex-1">
                        <p className="text-sm font-medium text-brand-navy truncate" data-testid={`text-document-name-${doc.id}`}>
                          {doc.name}
                        </p>
                      ...
                      <button
                        ...
                        className="ml-4 text-xs font-medium text-brand-blue hover:text-brand-navy border border-brand-blue/30 hover:border-brand-navy/30 rounded-full px-3 py-1.5 transition-colors disabled:opacity-50"
                      >
