              ...
              <div className="rounded-xl border border-slate-200 overflow-hidden">
                ...
                <table className="w-full text-sm" data-testid="table-assets">
                  ...
                  <tbody>
                    ...
                    {data.balanceSheet.filter((b) => b.type === "asset" && b.category === "non-current").map((item) => (
                      <tr key={item.name} className="border-b border-slate-50">
                        <td className="px-6 py-2 text-slate-600 pl-10">{item.name}</td>
                        <td className="text-right px-6 py-2 font-mono text-slate-800">{formatCurrency(item.value * 1000)}</td>
                      </tr>
                    ))}
                    ...
                    {data.balanceSheet.filter((b) => b.type === "asset" && b.category === "current").map((item) => (
                      <tr key={item.name} className="border-b border-slate-50">
                        <td className="px-6 py-2 text-slate-600 pl-10">{item.name}</td>
                        <td className="text-right px-6 py-2 font-mono text-slate-800">{formatCurrency(item.value * 1000)}</td>
                      </tr>
                ...
                <table className="w-full text-sm" data-testid="table-liabilities">
                  ...
                  <tbody>
                    {data.balanceSheet.filter((b) => b.type === "liability").map((item) => (
                      <tr key={item.name} className="border-b border-slate-50">
                        <td className="px-6 py-2 text-slate-600">{item.name}</td>
                        <td className="text-right px-6 py-2 font-mono text-slate-800">{formatCurrency(item.value * 1000)}</td>
                      </tr>
                    ))}
                  </tbody>
