...
type GovernanceKey = "users" | "consents" | "reports" | "analytics" | "audio" | "requests" | "brand";
...
export default function DashboardClient({ assessments, workspaceSlug, primary, textColor, bgColor, headingFont, toolLinks, governanceLinks }: Props) {
  ...
  const governanceDescriptions: Record<GovernanceKey, { description: string; features: string[] }> = {
    ...
    brand: {
      description: "Corporate-Design-Richtlinien hochladen und verwalten. Style Guides per KI analysieren lassen und Branding-Regeln für Dokumente, Übungen und Exporte definieren.",
      features: ["Style Guide Upload (PDF/DOCX)", "KI-gestützte Analyse", "Branding-Regelsets", "CD-Varianten für Übungen"],
    },
  };
