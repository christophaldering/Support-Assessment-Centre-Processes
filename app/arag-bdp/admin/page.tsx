          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="flex gap-2">
                ...
                <button data-testid="button-export-print" onClick={() => window.open("/arag-bdp/export/print", "_blank")} className="flex-1 bg-gray-100 py-2 rounded-lg text-sm hover:bg-gray-200">{t("printView")}</button>
              </div>
            </div>
            <div>
