...
const t = {
  de: {
    ...
    navLogin: "Anmelden",
    heroBadge: "Unsere Diagnostik-Plattform",
    heroTitle1: "Die KI unterst\u00fctzt.",
    heroTitle2: "Wir verantworten.",
    heroSub: "Unser eigenes Werkzeug f\u00fcr den kompletten AC-Prozess \u2014 von der Anforderungsanalyse bis zum fertigen Ergebnisbericht. KI-gest\u00fctzt, rechtskonform, und immer unter unserer fachlichen Kontrolle.",
    heroCta1: "Was wir damit k\u00f6nnen",
    ...
    uspBadge: "Unser Ansatz",
    uspTitle: "Software allein ist nicht der Wert.",
    uspSub: "Unser Angebot: inhaltliche und konzeptionell-methodische Kompetenz, Durchf\u00fchrungserfahrung und Benchmarks \u2014 dies aber nun gest\u00fctzt von modernster KI-Technologie.",
    uspPillar1Title: "Fachliche Kompetenz",
    uspPillar1Desc: "Jahrelange Erfahrung in der eignungsdiagnostischen Praxis. Methodenwissen, das keine Software ersetzen kann.",
    uspPillar2Title: "Durchf\u00fchrungs\u00aderfahrung",
    uspPillar2Desc: "Hunderte Assessment Center konzipiert und begleitet. Unser Erfahrungsschatz flie\u00dft direkt in die Plattform ein.",
    uspPillar3Title: "Benchmarks & Normen",
    uspPillar3Desc: "Unsere gewachsene Datenbasis erm\u00f6glicht fundierte Einordnung \u2014 kein Tool ohne Referenzrahmen.",
    uspPillar4Title: "KI-Technologie",
    uspPillar4Desc: "Modernste KI beschleunigt Routineaufgaben, generiert Vorschl\u00e4ge und erm\u00f6glicht Analysen in neuer Tiefe. Als Werkzeug, nicht als Entscheider.",
    uspFootnote: "Die KI ist unser sch\u00e4rfstes Werkzeug \u2014 aber die Verantwortung bleibt beim Menschen.",
    processBadge: "End-to-End",
    processTitle: "Unser kompletter AC-Prozess \u2014 durchg\u00e4ngig KI-gest\u00fctzt",
    processSub: "Von der ersten Anforderungsanalyse bis zum fertigen Ergebnisbericht \u2014 ein durchg\u00e4ngiger Prozess ohne Medienbr\u00fcche. Die KI unterst\u00fctzt bei jedem Schritt. Die fachliche Verantwortung bleibt bei uns.",
    ...
    candTitle: "Zeitgem\u00e4\u00dfe Darreichung f\u00fcr unsere Teilnehmenden",
    candSub: "Unser Kandidatenportal hebt die Teilnehmerkommunikation auf ein neues Level \u2014 professionell, im Corporate Design des Kunden, mit zeitgesteuerter Freigabe und integrierter Selbsteinsch\u00e4tzung.",
    candBeforeTitle: "Bisheriger Prozess",
    candBeforeItems: [
      "Einladung und Unterlagen \u00fcber separate Kan\u00e4le",
      "Zeitplanung manuell koordiniert",
      "Dokumente einzeln zusammengestellt",
      "Keine einheitliche Darstellung im Kunden-CI",
      "Selbsteinsch\u00e4tzungen separat verwaltet",
    ],
    candAfterTitle: "Mit unserer Plattform",
    candAfterItems: [
      "Eigenes Kandidatenportal pro Assessment",
      "Zeitgesteuerte Dokumentenfreigabe",
      "Im Corporate Design des Kunden",
      "Digitale Selbsteinsch\u00e4tzungen integriert",
      "DSGVO-konformes Consent Management",
    ],
    candFootnote: "Unsere Kandidaten erleben ein Assessment, das so professionell ist wie die Position, f\u00fcr die sie sich bewerben.",
    ...
    trustSectionTitle: "KI unterst\u00fctzt. Wir verantworten.",
    trustSectionSub: "Unsere KI ist ein diagnostisches Werkzeug \u2014 kein Entscheider. Alle KI-Ausgaben sind transparent gekennzeichnet, konfidenzbewertet und vollst\u00e4ndig audit-geloggt. Die fachliche Verantwortung bleibt immer beim Menschen.",
  ...
  en: {
    ...
    navFrameworks: "Frameworks",
    navLogin: "Sign In",
    heroBadge: "Our Diagnostics Platform",
    heroTitle1: "AI supports.",
    heroTitle2: "We decide.",
    heroSub: "Our own toolset for the entire AC process \u2014 from requirements analysis to the final assessment report. AI-supported, legally compliant, and always under our professional control.",
    heroCta1: "See what we can do",
    ...
    uspBadge: "Our Approach",
    uspTitle: "Software alone is not the value.",
    uspSub: "Our offering: subject-matter expertise, methodological competence, hands-on experience and benchmarks \u2014 now powered by cutting-edge AI technology.",
    uspPillar1Title: "Subject Expertise",
    uspPillar1Desc: "Years of experience in diagnostic practice. Methodological know-how that no software can replace.",
    uspPillar2Title: "Hands-on Experience",
    uspPillar2Desc: "Hundreds of assessment centers designed and facilitated. Our wealth of experience flows directly into the platform.",
    uspPillar3Title: "Benchmarks & Norms",
    uspPillar3Desc: "Our established data foundation enables well-grounded classification \u2014 no tool without a frame of reference.",
    uspPillar4Title: "AI Technology",
    uspPillar4Desc: "State-of-the-art AI accelerates routine tasks, generates suggestions and enables analyses of new depth. As a tool, not a decision-maker.",
    uspFootnote: "AI is our sharpest tool \u2014 but the responsibility remains with the people.",
    processBadge: "End-to-End",
    processTitle: "Our complete AC process \u2014 AI-supported throughout",
    processSub: "From the initial requirements analysis to the finished assessment report \u2014 a seamless process without media breaks. AI supports at every step. Professional responsibility stays with us.",
    ...
    candTitle: "A modern experience for our participants",
    candSub: "Our candidate portal takes participant communication to the next level \u2014 professional, in the client\u2019s corporate design, with scheduled release and integrated self-assessment.",
    candBeforeTitle: "Previous process",
    candBeforeItems: [
      "Invitations and documents via separate channels",
      "Scheduling manually coordinated",
      "Documents individually compiled",
      "No unified presentation in client CI",
      "Self-assessments managed separately",
    ],
    candAfterTitle: "With our platform",
    candAfterItems: [
      "Dedicated candidate portal per assessment",
      "Scheduled document release",
      "In the client\u2019s corporate design",
      "Digital self-assessments integrated",
      "GDPR-compliant consent management",
    ],
    candFootnote: "Our candidates experience an assessment that is as professional as the position they are applying for.",
    ...
    trustSectionTitle: "AI supports. We take responsibility.",
    trustSectionSub: "Our AI is a diagnostic tool \u2014 not a decision-maker. All AI outputs are transparently labeled, confidence-scored and fully audit-logged. Professional responsibility always stays with the people.",
      ...
      <section className="py-20 bg-gradient-to-b from-slate-50 to-white border-b border-slate-100">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { title: l.uspPillar1Title, desc: l.uspPillar1Desc, icon: "M4.26 10.147a60.438 60.438 0 00-.491 6.347A48.62 48.62 0 0112 20.904a48.62 48.62 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.636 50.636 0 00-2.658-.813A59.906 59.906 0 0112 3.493a59.903 59.903 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.717 50.717 0 0112 13.489a50.702 50.702 0 017.74-3.342M6.75 15a.75.75 0 100-1.5.75.75 0 000 1.5zm0 0v-3.675A55.378 55.378 0 0112 8.443m-7.007 11.55A5.981 5.981 0 006.75 15.75v-1.5", color: "text-brand-navy", bg: "bg-slate-100" },
              { title: l.uspPillar2Title, desc: l.uspPillar2Desc, icon: "M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z", color: "text-brand-navy", bg: "bg-slate-100" },
              ...
              { title: l.uspPillar4Title, desc: l.uspPillar4Desc, icon: "M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z", color: "text-brand-blue", bg: "bg-blue-50" },
            ].map((pillar) => (
