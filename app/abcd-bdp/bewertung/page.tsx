          ...
          {openSessions.length > 0 && (
            <div>
              ...
              <div className="space-y-3">
                {openSessions.map(s => (
                  <Link key={s.id} href={`/abcd-bdp/bewertung/${s.id}`} data-testid={`card-score-session-${s.id}`} className="block bg-white rounded-2xl p-5 shadow-sm hover:shadow-md transition-all border-l-4 border-green-400">
