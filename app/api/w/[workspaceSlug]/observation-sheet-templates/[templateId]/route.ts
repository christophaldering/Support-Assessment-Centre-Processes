  ...
  try {
    ...
    const updated = await prisma.observationSheetTemplate.update({
      ...
      data: {
        ...
        structuredData: body.structuredData !== undefined ? body.structuredData : undefined,
        ratingScale: body.ratingScale !== undefined ? body.ratingScale : undefined,
        exerciseIds: body.exerciseIds !== undefined ? body.exerciseIds : undefined,
        competencyModelId: body.competencyModelId !== undefined ? body.competencyModelId : undefined,
        competencyNames: body.competencyNames !== undefined ? body.competencyNames : undefined,
