/**
 * GET /api/w/[workspaceSlug]/dr/links/[linkId]/events
 *
 * Returns the event timeline for a single DataRoomAccessLink.
 * Scoped to the requesting workspace — cross-workspace access denied.
 */
