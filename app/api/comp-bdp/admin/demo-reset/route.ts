...
async function deleteDemo() {
  ...
  const demoIds = demoEntities.filter(e => e.entityType.startsWith("demo_") || e.realName.includes("@comp-demo.eu") || e.realName.includes("@participants-demo.eu") || e.realName.includes("@demo.de")).map(e => e.id);
  if (demoIds.length > 0) {
...
async function seedDemo() {
  ...
  const observerDefs = [
    { code: "D-V1", role: "BOARD", displayName: "Marie Curie (V1)", realName: "Marie Curie", email: "curie@comp-demo.eu", isAdmin: false, pw: "Demo", demoLock: false },
    { code: "D-V2", role: "BOARD", displayName: "Alan Turing (V2)", realName: "Alan Turing", email: "turing@comp-demo.eu", isAdmin: false, pw: "Demo", demoLock: false },
    { code: "D-V3", role: "BOARD", displayName: "Hannah Arendt (V3)", realName: "Hannah Arendt", email: "arendt@comp-demo.eu", isAdmin: false, pw: "Demo", demoLock: false },
    { code: "D-V4", role: "BOARD", displayName: "Ada Lovelace (V4)", realName: "Ada Lovelace", email: "lovelace@comp-demo.eu", isAdmin: false, pw: "Demo", demoLock: false },
    { code: "D-V5", role: "BOARD", displayName: "Nikola Tesla (V5)", realName: "Nikola Tesla", email: "tesla@comp-demo.eu", isAdmin: false, pw: "Demo", demoLock: false },
    { code: "D-V6", role: "BOARD", displayName: "Simone de Beauvoir (V6)", realName: "Simone de Beauvoir", email: "beauvoir@comp-demo.eu", isAdmin: false, pw: "Demo", demoLock: false },
    { code: "D-MD1", role: "MANAGEMENT_DIAGNOSTICS", displayName: "Virginia Woolf (MD1)", realName: "Virginia Woolf", email: "woolf@comp-demo.eu", isAdmin: true, pw: "Demo", demoLock: false },
    { code: "D-E1", role: "EXPERT", displayName: "Peter Drucker (E1)", realName: "Peter Drucker", email: "drucker@comp-demo.eu", isAdmin: false, pw: "Demo", demoLock: false },
