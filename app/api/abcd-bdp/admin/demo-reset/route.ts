...
async function deleteDemo() {
  ...
  const demoIds = demoEntities.filter(e => e.entityType.startsWith("demo_") || e.realName.includes("@abcd-demo.eu") || e.realName.includes("@participants-demo.eu") || e.realName.includes("@demo.de")).map(e => e.id);
  if (demoIds.length > 0) {
...
async function seedDemo() {
  ...
  const avatarMap: Record<string, string> = {
    "A-V1": "/demo-avatars/curie.svg",
    "A-V2": "/demo-avatars/turing.svg",
    "A-V3": "/demo-avatars/arendt.svg",
    "A-V4": "/demo-avatars/lovelace.svg",
    "A-V5": "/demo-avatars/tesla.svg",
    "A-V6": "/demo-avatars/beauvoir.svg",
    "A-MD1": "/demo-avatars/woolf.svg",
    "A-E1": "/demo-avatars/drucker.svg",
    "A-V7": "/demo-avatars/aurelius.svg",
  };

  const observerDefs = [
    { code: "A-V1", role: "BOARD", displayName: "Marie Curie (V1)", realName: "Marie Curie", email: "curie@abcd-demo.eu", isAdmin: false, pw: "Demo", demoLock: false },
    { code: "A-V2", role: "BOARD", displayName: "Alan Turing (V2)", realName: "Alan Turing", email: "turing@abcd-demo.eu", isAdmin: false, pw: "Demo", demoLock: false },
    { code: "A-V3", role: "BOARD", displayName: "Hannah Arendt (V3)", realName: "Hannah Arendt", email: "arendt@abcd-demo.eu", isAdmin: false, pw: "Demo", demoLock: false },
    { code: "A-V4", role: "BOARD", displayName: "Ada Lovelace (V4)", realName: "Ada Lovelace", email: "lovelace@abcd-demo.eu", isAdmin: false, pw: "Demo", demoLock: false },
    { code: "A-V5", role: "BOARD", displayName: "Nikola Tesla (V5)", realName: "Nikola Tesla", email: "tesla@abcd-demo.eu", isAdmin: false, pw: "Demo", demoLock: false },
    { code: "A-V6", role: "BOARD", displayName: "Simone de Beauvoir (V6)", realName: "Simone de Beauvoir", email: "beauvoir@abcd-demo.eu", isAdmin: false, pw: "Demo", demoLock: false },
    { code: "A-MD1", role: "MANAGEMENT_DIAGNOSTICS", displayName: "Virginia Woolf (MD1)", realName: "Virginia Woolf", email: "woolf@abcd-demo.eu", isAdmin: true, pw: "Demo", demoLock: false },
    { code: "A-E1", role: "EXPERT", displayName: "Peter Drucker (E1)", realName: "Peter Drucker", email: "drucker@abcd-demo.eu", isAdmin: false, pw: "Demo", demoLock: false },
    { code: "A-V7", role: "BOARD", displayName: "Marcus Aurelius (V7)", realName: "Marcus Aurelius", email: "aurelius@demo.de", isAdmin: false, pw: "aurelius", demoLock: true },
  ];
  ...
  const teamDefs = [
    { code: "A-Team1", displayName: "Lisbon", city: "Lisbon" },
    { code: "A-Team2", displayName: "Vienna", city: "Vienna" },
    { code: "A-Team3", displayName: "Prague", city: "Prague" },
    { code: "A-Team4", displayName: "Oslo", city: "Oslo" },
    { code: "A-Team5", displayName: "Valencia", city: "Valencia" },
    { code: "A-Team6", displayName: "Krakow", city: "Krakow" },
  ];

  const teamFeedback: Record<number, string> = {
    0: "Das Team Lisbon überzeugte durch strategische Klarheit und eine strukturierte Herangehensweise. Die Präsentation war prägnant, das Q&A solide – wenngleich Elizabeth Bennet gelegentlich so wirkte, als würde sie den Raum nach einem würdigen Mr. Darcy abscannen statt nach Gegenargumenten.",
    1: "Team Vienna brachte unternehmerische Kreativität und eine erfrischende Dynamik in die Session. Anna Karenina führte mit Leidenschaft – bisweilen so intensiv, dass die Risikoabwägung etwas zu kurz kam. Don Quijotes visionärer Ansatz war inspirierend, hätte aber von etwas mehr Bodenhaftung profitiert.",
    2: "Das Team Prague überzeugte durch strategische Stringenz. Die Präsentation war präzise, wenngleich im Q&A ein Moment entstand, in dem selbst Sherlock Holmes kurz nach der Logik suchte. Die Zahlenlogik war durchgängig belastbar, die Teamdynamik produktiv.",
    3: "Team Oslo zeigte eine beeindruckend kohärente Teamleistung. Jean Valjean führte mit der stillen Autorität eines Mannes, der weiß, was es bedeutet, sich durchzusetzen. Cosettes empathischer Ansatz ergänzte die analytische Schärfe hervorragend. Im Defense kam das Team mit hauchdünnem Abstand an Prague heran.",
    4: "Team Valencia lieferte eine solide Gesamtleistung mit guter Rollenverteilung. Odysseus führte mit ruhiger Hand durch unbekannte Gewässer – ein Ansatz, der an seine legendären Irrfahrten erinnerte, diesmal aber deutlich zielgerichteter ausfiel.",
    5: "Team Krakow zeigte kreative Ansätze bei der Strategieentwicklung. Winston Smith brachte eine ungewöhnlich kritische Perspektive ein, die das Team produktiv herausforderte. Gandalf bewies einmal mehr, dass ein weiser Berater den Unterschied machen kann – auch ohne Zauberstab.",
  };
  ...
  const participantDefs = [
    { code: "A-TN1", realName: "Elizabeth Bennet", email: "bennet@participants-demo.eu" },
    { code: "A-TN2", realName: "Mr. Darcy", email: "darcy@participants-demo.eu" },
    { code: "A-TN3", realName: "Sherlock Holmes", email: "holmes@participants-demo.eu" },
    { code: "A-TN4", realName: "Dr. Watson", email: "watson@participants-demo.eu" },
    { code: "A-TN5", realName: "Anna Karenina", email: "karenina@participants-demo.eu" },
    { code: "A-TN6", realName: "Gregor Samsa", email: "samsa@participants-demo.eu" },
    { code: "A-TN7", realName: "Don Quijote", email: "quijote@participants-demo.eu" },
    { code: "A-TN8", realName: "Sancho Panza", email: "panza@participants-demo.eu" },
    { code: "A-TN9", realName: "Jay Gatsby", email: "gatsby@participants-demo.eu" },
    { code: "A-TN10", realName: "Atticus Finch", email: "finch@participants-demo.eu" },
    { code: "A-TN11", realName: "Hermione Granger", email: "granger@participants-demo.eu" },
    { code: "A-TN12", realName: "Jean Valjean", email: "valjean@participants-demo.eu" },
    { code: "A-TN13", realName: "Cosette Fauchelevent", email: "cosette@participants-demo.eu" },
    { code: "A-TN14", realName: "Odysseus", email: "odysseus@participants-demo.eu" },
    { code: "A-TN15", realName: "Penelope", email: "penelope@participants-demo.eu" },
    { code: "A-TN16", realName: "Hamlet", email: "hamlet@participants-demo.eu" },
    { code: "A-TN17", realName: "Ophelia", email: "ophelia@participants-demo.eu" },
    { code: "A-TN18", realName: "Huckleberry Finn", email: "huck@participants-demo.eu" },
    { code: "A-TN19", realName: "Winston Smith", email: "smith@participants-demo.eu" },
    { code: "A-TN20", realName: "Clarissa Dalloway", email: "dalloway@participants-demo.eu" },
    { code: "A-TN21", realName: "Gandalf", email: "gandalf@participants-demo.eu" },
    { code: "A-TN22", realName: "Holden Caulfield", email: "caulfield@demo.de", demoLock: true, pw: "caulfield" },
  ];

  const participants: any[] = [];
  for (const def of participantDefs) {
    const p = await prisma.bdpParticipant.create({
      data: { id: randomUUID(), code: def.code, displayName: `${def.realName} (${def.code.replace("A-","")})`, environment: ENV, workspace: WS },
    });
    participants.push(p);
  ...
  const sessionSummaries = [
    "Session 1 bot einen überzeugenden Auftakt. Lisbon setzte mit strategischer Klarheit den Maßstab, während Vienna durch unternehmerische Kreativität überraschte. Im Q&A zeigte Lisbon die größere Souveränität – Elizabeth Bennet führte mit einer Präzision, die Jane Austen stolz gemacht hätte. Insgesamt ein starkes Feld mit klarer Tendenz zugunsten Lisbons.",
    "Die zweite Session war das strategische Herzstück des Tages. Prague und Oslo lieferten sich ein Kopf-an-Kopf-Rennen, das erst im Tie-Break entschieden werden konnte. Beide Teams zeigten exzellente Vorbereitung. Die finale Entscheidung fiel zugunsten Pragues – mit hauchdünnem Vorsprung und nach intensiver Diskussion der Q&A-Performance.",
    "Session 3 rundete den Tag mit einem dynamischen Duell ab. Valencia überzeugte durch operative Tiefe und strukturierte Umsetzungspläne, während Krakow mit frischen strategischen Impulsen punktete. Odysseus navigierte sein Team mit beinahe homerischer Weitsicht durch die Untiefen des Business Cases.",
  ];

  const sessions: any[] = [];
  const sessionDefs = [
    { name: "BDP Session 1 — Lisbon vs Vienna", teamIdxs: [0, 1] },
    { name: "BDP Session 2 — Prague vs Oslo", teamIdxs: [2, 3] },
    { name: "BDP Session 3 — Valencia vs Krakow", teamIdxs: [4, 5] },
  ];
  ...
  const sessionObserverMap: Record<number, string[]> = {
    0: ["A-V1", "A-V4", "A-MD1", "A-E1"],
    1: ["A-V2", "A-V5", "A-MD1", "A-E1"],
    2: ["A-V3", "A-V6", "A-MD1", "A-V7"],
  };
  ...
  const sponsorMap: Record<number, { obsCode: string; teamIdx: number }> = {
    0: { obsCode: "A-V1", teamIdx: 0 },
    1: { obsCode: "A-V2", teamIdx: 2 },
    2: { obsCode: "A-V3", teamIdx: 5 },
  };
  ...
  const scorePatterns: Record<number, Record<string, number[][]>> = {
    0: {
      "A-V1":  [[68,32],[54,46],[58,42],[52,48],[66,34]],
      "A-V4":  [[60,40],[58,42],[55,45],[56,44],[57,43]],
      "A-MD1": [[56,44],[53,47],[44,56],[58,42],[60,40]],
      "A-E1":  [[58,42],[55,45],[56,44],[52,48],[54,46]],
    },
    2: {
      "A-V3":  [[56,44],[52,48],[54,46],[58,42],[55,45]],
      "A-V6":  [[54,46],[50,50],[52,48],[55,45],[53,47]],
      "A-MD1": [[53,47],[48,52],[44,56],[57,43],[56,44]],
      "A-V7":  [[52,48],[51,49],[50,50],[53,47],[52,48]],
    },
  };
