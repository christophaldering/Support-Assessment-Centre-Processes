...
export default function BdpProfilePage() {
  ...
  const handleSave = async () => {
    ...
    setSaved(false);
    try {
      await fetch("/api/comp-bdp/auth/session", {
        method: "PUT",
  ...
  const handlePhotoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const res = await fetch("/api/comp-bdp/avatar", { method: "POST", body: formData });
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm">
        ...
        <div className="space-y-1 text-sm">
          ...
          <div className="flex justify-between py-2 border-b border-gray-100">
            ...
            <span className="font-medium" data-testid="text-profile-workspace">comp</span>
          </div>
          <div className="flex justify-between py-2 border-b border-gray-100">
