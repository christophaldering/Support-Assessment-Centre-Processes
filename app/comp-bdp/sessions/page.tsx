    ...
    <div className="space-y-4">
      ...
      {error ? (
        ...
        <div className="space-y-3">
          {sessions.map(s => (
            <Link key={s.id} href={`/comp-bdp/sessions/${s.id}`} data-testid={`bdp-session-row-${s.id}`} className="block bg-white rounded-2xl p-5 shadow-sm hover:shadow-md transition-shadow">
