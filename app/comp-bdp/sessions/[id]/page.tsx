  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        <Link href="/comp-bdp/sessions" className="text-gray-400 hover:text-black">{t("back")}</Link>
      </div>
      ...
      {session.state === "OPEN" && (
        <Link href={`/comp-bdp/bewertung/${session.id}`} data-testid="link-start-bewertung" className="block bg-[#FFD700] text-black font-bold py-4 rounded-2xl text-center hover:bg-[#E6C200] transition-colors">
          {t("startRating")}
        </Link>
      )}
    </div>
